export default class StudentList extends HTMLElement {
    ...
    renderList() {
        this.shadowObj.querySelector('.student-list__student-list').innerHTML = this.getStudents();
    }
    ...
    getTemplate() {
        return `
            <div class="student-list__form">
                <input type="text" name="student-name" class="student-list__input" placeholder="Enter student name here" />
