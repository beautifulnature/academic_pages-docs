...
:imagesdir: {moduledir}/assets/images/programming/c/ds
...
. Checking fourth element of array with elements before it and inserting it in proper position. 
In this case 5 is inserted in position of 12.
+
image::insertion_sort-3.png[]
. Checking fifth element of array with elements before it and inserting it in proper position. 
...
image::tree-binary-traversal-preorder.png[]
...
image::tree-binary-traversal-inorder.png[]
...
image::tree-binary-traversal-postorder.png[]
...
image::tree-binary-search-example.png[]
...
*Algorithm for inserting a new node in a binary search tree*
.Insert (TREE, VAL)
----
...
image::tree-binary-search-insert.png[]
...
image::tree-binary-search-delete-no-child.png[]
...
image::tree-binary-search-delete-one-child.png[]
...
image::tree-binary-search-delete-two-child.png[]
...
image::tree-heap-2.png[]

After processing array[3] the situation is:

image::tree-heap-3.png[]
